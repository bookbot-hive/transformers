...
class DataTrainingArguments:
    ...
    revision: str = field(default="main", metadata={"help": "Version of the dataset script to load."})
...
def main():
    ...
    # 3. Next, let's load the processor used by the teacher model during training
    ...
    student = AutoModelForCTC.from_pretrained(
        model_args.model_name_or_path,
        cache_dir=model_args.cache_dir,
        config=config,
        use_auth_token=data_args.use_auth_token,
